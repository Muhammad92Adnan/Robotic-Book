...
![Humanoid Perception Systems](/img/chapters/perception-systems-humanoids.jpg "Sensors and perception systems in humanoid robots")
...
![Types of Sensors in Humanoid Robots](/img/chapters/sensor-types-humanoids.jpg "Different types of sensors used in humanoid robots")
...
![RGB Cameras in Robotics](/img/chapters/rgb-cameras-robotics.jpg "RGB cameras used in robotic systems")
...
![Depth Cameras](/img/chapters/depth-cameras.jpg "Depth cameras for 3D perception in robotics")
...
![IMU Sensors](/img/chapters/imu-sensors.jpg "Inertial Measurement Units in humanoid robots")
...
![Ultrasonic Sensors](/img/chapters/ultrasonic-sensors.jpg "Ultrasonic sensors for proximity detection")
...
![IR Sensors](/img/chapters/ir-sensors.jpg "Infrared sensors in robotics")
...
![LiDAR Systems](/img/chapters/lidar-systems.jpg "LiDAR systems for 3D mapping in humanoid robots")
