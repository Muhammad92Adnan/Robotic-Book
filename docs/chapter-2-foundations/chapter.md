...
![Robotic System Components](/img/chapters/robot-components.jpg "Core components of a robotic system: sensors, actuators, and controllers")
...
![Robot Components Diagram](/img/chapters/robot-parts-diagram.jpg "Diagram showing sensors, actuators, and controllers in a robot")
...
![Sensor Types](/img/chapters/robot-sensors.jpg "Different types of sensors used in robotics")
...
![Actuator Types](/img/chapters/actuator-types.jpg "Various types of actuators used in robotics")
...
![Wheeled Robots](/img/chapters/wheeled-robots.jpg "Various wheeled robot configurations")
...
![Bipedal Robots](/img/chapters/bipedal-robots.jpg "Examples of bipedal robots walking and balancing")
...
![Arm Robots](/img/chapters/arm-robots.jpg "Different types of robotic arms and manipulators")

## Open-Loop vs Closed-Loop Control

Control systems determine how robots execute tasks and respond to environmental changes.

![Control Systems Comparison](/img/chapters/open-closed-loop-control.jpg "Comparison between open-loop and closed-loop control systems")
...
![System Integration](/img/chapters/robot-system-integration.jpg "Integration of sensors, controllers, and actuators in robotic systems")
