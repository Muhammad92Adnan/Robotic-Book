...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://robotic-book-humaniod.vercel.app", "https://robotic-book.vercel.app", "http://localhost:3000", "http://localhost:3001", "https://*.vercel.app"],  # Add your frontend domains
